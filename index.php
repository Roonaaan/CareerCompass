...
<html class="no-js" lang="zxx">
    <head>
		...
		<!-- Tab Logo -->
        <link rel="icon" href="img/compass-tab-logo.png">
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-6 col-md-5 col-12">
							<!-- Contact -->
							<img class="topright-logo" src="img/final-topright-logo.png">
						...
						<div class="col-lg-6 col-md-7 col-12">
							...
							<ul class="top-contact">
								<li><a class="log-in-text" href="#">Log-in</a></li>
								<li><a class="sign-up-text" href="#">Sign-up</a></li>
							</ul>
							<!-- End Top Contact -->
						</div>
					</div>
				...
				<div class="single-slider" style="background-image:url('img/banner-2.jpg')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
									<h1>Create your own <span>Roadmap</span> </h1>
									<p>Discover your own career path! Input your skills and experiences, and our system crafts a personalized roadmap just for you.  </p>
									<div class="button">
										<a href="#" class="btn">Create Roadmap</a>
				...
				<div class="single-slider" style="background-image:url('img/banner-1.jpg')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
									<h1>Gain <span>insights</span> and a <span>career plan</span> for yourself</h1>
				...
				<div class="single-slider" style="background-image:url('img/banner-3.jpg')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
									<h1>All that in just <span>one click</span> </h1>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris sed nisl pellentesque, faucibus libero eu, gravida quam. </p>
									<div class="button">
										<a href="#" class="btn">Create Roadmap</a>
										<a href="#" class="btn primary">Log in</a>
							...
							<div class="single-schedule first">
								<div class="inner">
									...
									<div class="single-content">
										<span>Feature 1</span>
										<h4>Assess Skills</h4>
										<p>Assesses your skills, experience, and qualifications to give you the best career path. </p>
							...
							<div class="single-schedule middle">
								<div class="inner">
									...
									<div class="single-content">
										...
										<p>Generates personalized learning plans where your skill gaps will be improved to achieve your desired career goals.</p>
							...
							<div class="single-schedule last">
								<div class="inner">
									...
									<div class="single-content">
										...
										<p>Track your own development, milestones and accomplishments along your chosen career path</p>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-12">
							<div class="copyright-content">
								<p>© Copyright 2024 | CareerCompass All Rights Reserved </p>
							</div>
						</div>
					</div>
				</div>
